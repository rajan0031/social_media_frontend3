                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleformdata} className="space-y-4 md:space-y-6">
                                ...
                                {/* // user name  sections this is our username section start*/}
                                <div>
                                ...
                                {/* password section  starting points */}
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Do not  have an account? <a href="google.com" className="font-medium text-primary-600 hover:underline dark:text-primary-500"><Link to="/register">Register here today </Link></a>
                                </p>
                            </form>
